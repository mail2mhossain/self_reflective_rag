...
from .chunking      import suggest_chunk_sizes
from .loader        import get_dox_from_file
from .qa_utils      import get_question_answers
from .vector_store  import store_in_vector_db
from .mongo_store   import store_parent_docs_in_mongodb
from .config        import parent_id_key, file_id_key


# python -m dox_pipeline.pipeline
...
if __name__ == "__main__":
    dox_pipeline("dox_pipeline/Homo_sapiens.pdf")